                                ...
                                >
                                    <div className='header__menu-mobile-stack'>
                                        ...
                                        <div className='header__socials'>
                                            <a href='https://t.me/+DDp9umNwnS9jMTNk' target='_blank' rel='noopener noreferrer' aria-label='Telegram'>
                                                <Icon icon='IcTelegram' width={22} height={22} />
                                            </a>
                                            <a href='https://www.instagram.com/gletraders?igsh=aDUzOXlnODQydWRl' target='_blank' rel='noopener noreferrer' aria-label='Instagram'>
                                            ...
                                            <a href='https://www.tiktok.com/@bnnjkjjk?_t=ZM-8zEZBx94Tws&_r=1' target='_blank' rel='noopener noreferrer' aria-label='TikTok'>
                            ...
                            <MobileDrawer.Body className={is_traders_hub_route || is_wallet_route ? 'no-padding' : ''}>
                                ...
                                <MobileDrawer.Item>
                                    ...
                                    >
                                        ...
                                        <span className='dc-menu-link__text'>{localize('ALPHA DBOT')}</span>
                                    </a>
                                </MobileDrawer.Item>
